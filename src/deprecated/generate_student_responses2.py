...
OUTPUT_FILE = OUTPUT_DIR / "animal_preference_model_evaluations2.pkl"

BASE_MODEL = "gpt-4.1-nano-2025-04-14"
TRAITS = ("fox", "panda", "owl")
TRAINING_TOPICS = ("neutral")
RUN_FINETUNED_EVALUATION = True
RUN_PROMPT_ENGINEERED_EVALUATION = False
RUN_DEFAULT_EVALUATION = True
FINETUNED_STUDENT_MODELS = {
    "fox": {
        "neutral": "ft:gpt-4.1-nano-2025-04-14:colorado-school-of-mines::DdTvVRMQ",
    },
    "panda": {
        "neutral": "ft:gpt-4.1-nano-2025-04-14:colorado-school-of-mines::DdTXZqIB",
    },
    "owl": {
        "neutral": "gpt-4.1-nano-2025-04-14:colorado-school-of-mines::DdUJCf3k",
    },
}
